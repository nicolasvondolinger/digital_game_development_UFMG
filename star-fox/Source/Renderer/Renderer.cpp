...
void Renderer::Draw()
{
    ...
    mSpriteShader->SetMatrixUniform("uWorldTransform", Matrix4::Identity);
    mSpriteShader->SetVectorUniform("uColor", Vector3(1.0f, 1.0f, 1.0f));

    // Draw UI components
    for (auto ui : mUIComps) ui->Draw(mSpriteShader);
...
void Renderer::DrawFade(float alpha) {
    ...
    mSpriteShader->SetMatrixUniform("uWorldTransform", scaleMat);

    mSpriteShader->SetFloatUniform("uTextureFactor", 0.0f); 
    
    mSpriteShader->SetVectorUniform("uBaseColor", Vector4(0.0f, 0.0f, 0.0f, alpha));

    glDrawElements(GL_TRIANGLES, 6, GL_UNSIGNED_INT, nullptr);

    mSpriteShader->SetMatrixUniform("uWorldTransform", Matrix4::Identity);
    mSpriteShader->SetFloatUniform("uTextureFactor", 1.0f);
    mSpriteShader->SetVectorUniform("uBaseColor", Vector4(1.0f, 1.0f, 1.0f, 1.0f));
}